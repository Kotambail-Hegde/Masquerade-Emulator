...
* Sometimes, a glitchy controller input behaviour which results in a hang is observed only during the intro scene of SMB3 in NES. Only way to recover is the reset the emulator.
